...
init -1 python hide:
    ...
    config.window_title = u"Greek Retold: Pygmalion and Aphrodite"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Project Sweeegggg"
    config.version = "4.0"
...
python early:
    config.save_directory = "Wow such project-1407467247"
...
init -1 python hide:
    ...
    renpy.music.register_channel("fire", "sfx", True)
